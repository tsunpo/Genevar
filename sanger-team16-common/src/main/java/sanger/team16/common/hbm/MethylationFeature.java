 ...
 */
public class MethylationFeature {
    private int id = 0;
    ...
    public MethylationFeature() {}

    public MethylationFeature(int populationId, int platformId, int tissueTypeId, int versionId, String description, String createdBy) {
    ...
    public MethylationFeature(int id, String description) {   //For MatchFeature
        this.setId(id);
        this.setDescription(description);
    }
