...
{
    public ReferenceDAO(String address) {
        super(address);
    }

    @SuppressWarnings("unchecked")
    public List<Reference> list() throws RuntimeException {
        List<Reference> objects = this.getSession().createQuery("FROM Reference ORDER BY name DESC").list();
